...
export const generatorIterator = (Generator: GeneratorEntity, key: 'dataEntities' | 'stateEntities' | 'events' ) => 
...
export const generatorSimpleEntity = (Generator: GeneratorEntity) => generatorIterator(Generator, 'stateEntities');
